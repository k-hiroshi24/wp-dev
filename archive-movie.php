...
<div class="p-service-tab p-service-content01" id="js-tab">
  <div class="p-service-tab__nav l-inner">
    ...
    <a href="archive-movie.html" class="p-service-tab__nav-item is-active contents02" data-nav="1">動画でみる活用事例</a>
    <a href="archive-column.html" class="p-service-tab__nav-item contents03" data-nav="2">ノウハウ・コラム</a>
  </div>
  <!-- 動画で見る活用事例 -->
